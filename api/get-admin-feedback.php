        ...
        if ($filter === 'members') {
            ...
            $stmt = $conn->prepare("
                SELECT
                    m.MemberID,
                    NULL as non_MemberID,
                    CONCAT(app.FName COLLATE utf8mb4_unicode_ci, ' ', app.LName COLLATE utf8mb4_unicode_ci) as MemberName,
                    app.FName COLLATE utf8mb4_unicode_ci as FName,
                    app.LName COLLATE utf8mb4_unicode_ci as LName,
                    app.ApplicantEmail COLLATE utf8mb4_unicode_ci as Email,
                    'Member' as UserType,
                    ea.AttendanceID,
                    ea.AttendanceTime,
                    f.FeedbackID,
                ...
                SELECT
                    NULL as MemberID,
                    nm.non_memberID as non_MemberID,
                    CONCAT(nm.Fname COLLATE utf8mb4_unicode_ci, ' ', nm.Lname COLLATE utf8mb4_unicode_ci) as MemberName,
                    nm.Fname COLLATE utf8mb4_unicode_ci as FName,
                    nm.Lname COLLATE utf8mb4_unicode_ci as LName,
                    nm.Email COLLATE utf8mb4_unicode_ci,
                    'Non-Member' as UserType,
                    ea.AttendanceID,
                    ea.AttendanceTime,
                    f.FeedbackID,
