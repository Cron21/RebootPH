            ...
            if ($filter === 'members') {
                ...
                $stmt = $conn->prepare("
                    SELECT 
                        ...
                        r.non_MemberID,
                        r.RegistrationDate,
                        a.FName COLLATE utf8mb4_unicode_ci as FName,
                        a.LName COLLATE utf8mb4_unicode_ci as LName,
                        a.ApplicantEmail COLLATE utf8mb4_unicode_ci as ApplicantEmail,
                        'Member' as UserType,
                        ea.AttendanceID,
                        ea.AttendanceTime,
                        ea.ScanType
                    ...
                    SELECT 
                        ...
                        nm.Email COLLATE utf8mb4_unicode_ci as ApplicantEmail,
                        'Non-Member' as UserType,
                        ea.AttendanceID,
                        ea.AttendanceTime,
                        ea.ScanType
