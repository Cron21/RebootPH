...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jan 06, 2026 at 07:51 PM
...
(44, 'Daniela', 'Gutierrez', 'Calpe', '', 'Female', NULL, 'Not Applicable', NULL, '2005-07-21', 'danielacalpe42@gmail.com', '$2y$10$.e4b7SXRYO71yPw2AsKRMe72aUZUE/oRpowW1vSG6Qo.qfkDd66ei', '2025-12-21 13:28:05', 1, '2025-12-21 14:23:54', NULL),
(47, 'Byron Anjelu', 'Aguila', 'Calajate', '', 'Male', NULL, 'Youth', NULL, '2003-02-21', 'byron.anjelu0221@gmail.com', '$2y$10$k659qD89GuXiO4Yb7.A8nOU.2qogC.MAUs2W3lW7ecnBAeV4SdLfe', '2025-12-22 04:46:48', 1, '2025-12-22 04:47:01', NULL),
(48, 'Mark', 'Belleza', 'Joseph', '', 'Male', NULL, 'Youth', NULL, '2003-04-16', 'bellezam43@gmail.com', '$2y$10$T5nhP4VBiYmRup3QvAhJW.qQNPJdQe3uI9vtsrRP2zhSA0/oW9zqq', '2025-12-22 04:49:48', 1, '2025-12-22 04:50:33', NULL),
(49, 'Juan', '', 'Dela Cruz', '', 'Male', NULL, 'Not Applicable', NULL, '2000-06-06', 'maryyyjanelle061605@gmail.com', NULL, '2026-01-06 16:42:46', 2, '2026-01-06 17:43:57', NULL),
(50, 'Mary Janelle', 'Caro', 'Caparros', '', 'Female', NULL, 'Not Applicable', NULL, '2005-06-16', 'caparrosmaryjanellec@gmail.com', '$2y$10$qsQ1K8bzuoT9BpH37/fGCuXkP1mgziocDLrTKaFZTleY8ZgdtXmIW', '2026-01-06 17:48:24', 1, '2026-01-06 17:48:35', NULL);
...
(85, 44, 1, 'qxwcwdfvergbtnhymu,mijynhbgvfcdxqxwcwdfvergbtnhymu,mijynhbgvfcdxqxwcwdfvergbtnhymu,mijynhbgvfcdxqxwcwdfvergbtnhymu,mijynhbgvfcdx'),
(86, 44, 6, 'qxwcwdfvergbtnhymu,mijynhbgvfcdxqxwcwdfvergbtnhymu,mijynhbgvfcdxqxwcwdfvergbtnhymu,mijynhbgvfcdxqxwcwdfvergbtnhymu,mijynhbgvfcdx'),
(91, 47, 1, 'I want to join Reboot PH because I am deeply committed to the transition toward a sustainable and energy-secure future for the Philippines. As a student, I’ve seen how our country is disproportionately affected by the climate crisis, and I believe that grassroots youth movements are the most effective way to drive systemic change. I am eager to learn from a community of like-minded advocates and contribute my energy to campaigns that prioritize renewable energy over fossil fuels. Joining Reboot PH is an opportunity for me to turn my academic knowledge into tangible climate action while growing as a young leader.'),
(92, 47, 6, 'In my past experiences as a campus volunteer, I have organized local awareness drives about waste management and sustainability, which taught me the importance of community mobilization. My long-term goal is to work in the field of environmental policy, and I see Reboot PH’s mission of advocating for a just energy transition as the perfect alignment for this career path.'),
(93, 48, 1, 'I want to join Reboot PH because I strongly support its mission to promote renewable energy and sustainable development in the Philippines. I believe that clean energy plays a vital role in addressing climate change and improving community resilience. Being part of an organization that actively advocates for energy transition gives me the opportunity to contribute to meaningful initiatives while learning from like-minded individuals who share the same vision for a greener and more sustainable future.'),
(94, 48, 6, 'My past experiences, particularly my background in information technology and involvement in system development and analysis, align with Reboot PH’s mission of innovation and sustainability. In the future, I aim to use my skills to support digital solutions, data management, and awareness initiatives that strengthen renewable energy advocacy. As a member, I hope to contribute through technical support, collaboration in projects, and active participation in programs that promote clean energy education and community engagement.'),
(95, 49, 1, 'ddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd'),
(96, 49, 6, 'ddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd'),
(97, 50, 1, 'NA'),
(98, 50, 6, 'NA');
...
(4, 5, 1, '2025-12-21 00:00:00', 154687, 0x4556454e542d352d363638363834, 1, '2025-12-22', NULL),
(7, 8, 1, '2025-12-22 00:00:00', 564233, 0x4556454e542d382d353634323333, 1, '2025-12-22', NULL);
...
INSERT INTO `eventattendance` (`AttendanceID`, `RegistrationID`, `AttendanceTime`, `ScanType`) VALUES
(1, 65, '2025-12-22 13:43:56', 'QR'),
(2, 68, '2026-01-06 19:12:39', 'NonMemberC');
...
INSERT INTO `feedback` (`FeedbackID`, `AttendanceID`, `SubmissionDate`, `Comments`, `Rating`, `OverallExperience`, `KnowledgeGained`, `IsAnonymous`) VALUES
(1, 1, '2026-01-06 08:59:59', 'food is good', '5', 'Good', 4, 0);
...
(8, 'Lead the Charge for a Greener Philippines.', 'Welcome, future leader! Join the community of youth-led energy advocates transitioning the nation to a sustainable future.', '2026-01-06 16:40:24', 1, 1, 1, '2026-01-06 16:40:24');
...
CREATE TABLE `member` (
  ...
  `Role` enum('Executive Director','Program Officer','Regional Convenor','Local Coordinator','Finance Officer','Meal Officer','Member Staff','Member','Admin') NOT NULL DEFAULT 'Member',
  `isActive` tinyint(1) NOT NULL DEFAULT 0,
...
(1, 1, 'uploads/profile-images/img_1766328315_d7b85c1bb6.jpg', 'Admin', 1, '2025-12-05'),
(11, 23, 'uploads/profile-images/img_1766328107_8b215ef1e8.jpg', 'Finance Officer', 1, '2025-12-18'),
(12, 22, 'uploads/profile-images/img_1766328018_a94ef0ba43.jpg', 'Executive Director', 1, '2025-12-18'),
(14, 24, 'uploads/profile-images/img_1766328138_3c2e4d8d99.jpg', 'Meal Officer', 1, '2025-12-18'),
(15, 25, 'uploads/profile-images/img_1766328169_b3d30c038e.jpg', 'Program Officer', 1, '2025-12-18'),
(16, 26, 'uploads/profile-images/img_1766328194_e25f9c88b4.jpg', 'Regional Convenor', 1, '2025-12-18'),
(17, 27, 'uploads/profile-images/img_1766328218_2140c283b5.jpg', 'Local Coordinator', 1, '2025-12-18'),
(18, 28, 'uploads/profile-images/img_1766327419_946493f5a5.jpg', 'Member Staff', 1, '2025-12-18'),
(70, 44, NULL, 'Member', 1, '2025-12-21'),
(72, 47, NULL, 'Member', 1, '2025-12-22'),
(73, 48, NULL, 'Member', 1, '2025-12-22'),
(74, NULL, NULL, 'Member', 0, '2026-01-06'),
(75, 50, NULL, 'Member', 1, '2026-01-06');
...
INSERT INTO `member_benefits` (`BenefitsID`, `Title`, `Description`, `isActive`, `CreateByAdminID`, `CreateDate`, `LastModifiedBy`, `LastModifiedDate`) VALUES
(2, 'Training, Workshops & Seminars', 'Gain access to exclusive learning sessions on climate action, renewable energy, and advocacy.', 1, 1, '2025-12-20', 1, '2026-01-06'),
(3, 'Local & National Initiatives', 'Participate in campaigns and projects that create real impact in communities across the Philippines.', 1, 1, '2025-12-20', 1, '2026-01-06'),
(4, 'Skill-Building', 'Develop leadership, communication, technical, and sustainability skills beyond the classroom.', 1, 1, '2025-12-20', 1, '2026-01-06'),
(5, 'Networking Opportunities', 'Connect with fellow youth advocates, mentors, and partner organizations.', 1, 1, '2025-12-20', 1, '2026-01-06'),
(6, 'Certificates &Recognition', 'Earn certificates and get recognized for your contributions and leadership.', 1, 1, '2025-12-20', 1, '2026-01-06'),
(7, 'Leadership Opportunities', 'Take part in planning and leading projects, events, and campaigns.', 0, 1, '2025-12-20', 1, '2026-01-06');
...
INSERT INTO `non_member` (`non_memberID`, `Lname`, `Fname`, `Mname`, `Email`) VALUES
(1, 'Calajate', 'Anjelu', '', 'panonymous870@gmail.com');
...
(74, 'Tonic Madulid', 'Executive Director', 'assets/image/team/tonic_madulid_1767701600.jpg', 0, 1);
...
(5, 'Ongoing Workshop - Reboot Skills', '2025-12-22', '09:00:00', '22:00:00', 'Conference Hall A', NULL, 50, NULL, NULL, 3, NULL, NULL, NULL, 1, '2025-12-22 02:57:52', 'Approved', 1, '2025-12-22 02:57:52'),
(8, 'test', '2025-12-23', '11:14:00', '16:14:00', 'test', 'test', 50, 'CEL (Climate and Energy Literacy)', 15000.00, 15, 'asd', 'test', '', 1, '2025-12-22 03:14:25', 'Approved', 1, '2025-12-22 03:14:27');
...
CREATE TABLE `registration` (
  ...
  `non_MemberID` int(11) DEFAULT NULL,
  `EventID` int(11) NOT NULL,
  `RegistrationDate` timestamp NOT NULL DEFAULT current_timestamp(),
  `RegistrationType` varchar(20) NOT NULL DEFAULT 'Attendee'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `registration` (`RegistrationID`, `MemberID`, `non_MemberID`, `EventID`, `RegistrationDate`, `RegistrationType`) VALUES
(62, 1, NULL, 4, '2025-12-22 02:58:05', 'Attendee'),
(65, 72, NULL, 4, '2025-12-22 06:29:39', 'Attendee'),
(67, 72, NULL, 7, '2025-12-22 12:10:34', 'Attendee'),
(68, NULL, 1, 4, '2026-01-06 18:22:08', 'Attendee');
...
ALTER TABLE `registration`
  ...
  ADD KEY `non_MemberID` (`non_MemberID`);
...
--
ALTER TABLE `announcement`
  MODIFY `AnnouncementID` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `application`
--
ALTER TABLE `application`
  MODIFY `ApplicationID` int(50) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;

--
-- AUTO_INCREMENT for table `applicationanswer`
--
ALTER TABLE `applicationanswer`
  MODIFY `AnswerID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;
...
--
ALTER TABLE `event`
  MODIFY `EventID` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `eventattendance`
--
ALTER TABLE `eventattendance`
  MODIFY `AttendanceID` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `member`
  MODIFY `MemberID` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;
...
--
ALTER TABLE `non_member`
  MODIFY `non_memberID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `org_team`
--
ALTER TABLE `org_team`
  MODIFY `member_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;

--
-- AUTO_INCREMENT for table `proposal`
--
ALTER TABLE `proposal`
  MODIFY `ProposalID` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `registration`
--
ALTER TABLE `registration`
  MODIFY `RegistrationID` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
...
ALTER TABLE `registration`
  ...
  ADD CONSTRAINT `registration_ibfk_3` FOREIGN KEY (`non_MemberID`) REFERENCES `non_member` (`non_memberID`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
